...
_TEMPLATES = {
    ...
    "find_data_on_web": "Look for data on the web[ for {query}]",
    "qgis_docs": "Read the QGIS documentation[ on {query}]",
    "terralab_docs": "Read the AI Agent documentation[ on {query}]",
    "find_datasets": "Search the data catalog[ for {query}]",
    "get_earthdata_collection_info": "Read a NASA Earthdata collection[ {short_name}]",
    "search_gee_catalog": "Search the Earth Engine catalog[ for {query}]",
    "search_copernicus_items": "Search Copernicus images[ of {collection}]",
    "get_sentinel_image": "Get a Sentinel image",
    "get_dem": "Get an elevation model",
    "resolve_place": "Look up the place[ {query}]",
    "find_statistic": "Search statistics[ on {topic}]",
